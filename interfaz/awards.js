document.addEventListener('click', function(e){
    ...
    if (e.target.classList.contains('anadirPremio')){
        clonarElemento('.premios', '.contenedor-premios', e);
    }
    

    if (e.target.classList.contains('quitarPremio')){
        eliminarElemento('.premios', '.contenedor-premios', e);
    }
