document.addEventListener('click', function(e){
    ...
    if (e.target.classList.contains('anadirSponsor')){
        clonarElemento('.sponsors', '.contenedor-sponsors', e);
    }

    if (e.target.classList.contains('quitarSponsor')){
        eliminarElemento('.sponsors', '.contenedor-sponsors', e);
    }
