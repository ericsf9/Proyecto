...
def main():
    ...
    uvengine = UVEngine('web_fm.uvl', ['web-configuration.json'], plantillas_data)
    ...
    uvengine = UVEngine('web_fm.uvl', ['web-configuration.json'], plantillas_pages)
    producto = uvengine.resolve_variability()
    ...
    uvengine = UVEngine('web_fm.uvl', ['web-configuration.json'], plantillas_includes)
    producto = uvengine.resolve_variability()
